...
def test_beam_reactions_ss_cant():
    ...
    assert beams.beam_reactions_ss_cant(w1, b1, a1) == (
        260680.55555555556,
        81819.44444444445,
    )
...
def test_separate_lines():
    ...
    assert beams.separate_lines(example_1_data) == [
        "cat, bat, hat",
        "troll, scroll, mole",
    ]
...
def test_convert_to_numeric():
    ...
    assert beams.convert_to_numeric(input) == [
...
def test_get_node_locations():
    ...
    beam_length2 = 210.0
    supports2 = [0.0, 210.0]
    assert beams.get_node_locations(supports1, beam_length1) == {
        "N0": 0.0,
        "N1": 1000.0,
        "N2": 4000.0,
        "N3": 8000.0,
...
def test_parse_supports():
    ...
    assert beams.parse_supports(supports) == {
        1000.0: "P",
        3800.0: "R",
        4800.0: "F",
        8000.0: "R",
...
def test_parse_beam_attributes():
    ...
    assert beams.parse_beam_attributes(input1) == {
        "L": 20e3,
        "E": 200e3,
        "Iz": 6480e6,
        "Iy": 390e6,
    ...
    assert beams.parse_beam_attributes(input2) == {
        "L": 4800,
        "E": 24500,
        "Iz": 1200000000,
        "Iy": 10,
